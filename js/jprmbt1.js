...
;(function($, window, document, undefined){
    ...
    defaults = {
       ...
       direction: 'vertical',   //è¿å¨æ¹å.  vertical : horizontal
       itemSelecter : 'li',  //å­èç¹éæ©å¨
       delay: 3000,  //å¨ç»æ¸²æå»¶è¿æ¶é´
       speed: 1,  //å¨ç»æ¸²æè·ç¦».
       timing: 1, //å¨ç»æ¸²æéç.
       mouse: true //é¼ æ ç§»å¥åæ­¢å¨ç»
    ...
    Widget.prototype = {
       ...
       init:function(){
           ...
           //å­èç¹å ç¨æ»é«åº¦.
            ...
            //å¤æ­å­èç¹æ»é«åº¦æ¯å¦å¤§äºç¶èç¹é«åº¦, å¦åæä»¶åæ­¢è¿è¡.
            if(totalSize < elmentTotalSize)return;

            //è®¾ç½®å¨ç»æ¸²ææéçCSSæ ·å¼.
            this.$wrapper.css({
